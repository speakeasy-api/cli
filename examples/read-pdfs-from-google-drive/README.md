...
2. OAuth2 credentials configured for your Speakeasy deployment
...
📖 [Speakeasy OAuth Configuration Documentation](https://www.speakeasy.com/docs/gram/gram-functions/oauth)
...
2. **Create OAuth2 credentials**:
   ...
   - Configure authorized redirect URIs for your Speakeasy deployment
...
- [Speakeasy OAuth Configuration](https://www.speakeasy.com/docs/gram/gram-functions/oauth)
