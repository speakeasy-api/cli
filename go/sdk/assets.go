...
func newAssets(rootSDK *Gram, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Assets {
	return &Assets{
		rootSDK:          rootSDK,
...
func (s *Assets) UploadFunctions(ctx context.Context, request operations.UploadFunctionsRequest, security operations.UploadFunctionsSecurity, opts ...operations.Option) (*operations.UploadFunctionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rpc/assets.uploadFunctions")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "Body", "raw", `request:"mediaType=application/octet-stream"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UploadFunctionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UploadFunctionsResult
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UploadFunctionsResult = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Assets) UploadOpenAPIv3(ctx context.Context, request operations.UploadOpenAPIv3AssetRequest, security operations.UploadOpenAPIv3AssetSecurity, opts ...operations.Option) (*operations.UploadOpenAPIv3AssetResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rpc/assets.uploadOpenAPIv3")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UploadOpenAPIv3AssetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.UploadOpenAPIv3Result
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UploadOpenAPIv3Result = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
